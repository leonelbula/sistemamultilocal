...
$('.tablaproductodevolucion').DataTable({
...
$(".tablaproductodevolucion tbody").on("click", "button.agregarProducto", function () {
   ...
   $.ajax({
      ...
      success: function (respuesta) {
         ...
         var costo = respuesta["precioventa"];
...
function QuitarAgregarProducto() {
   ...
   var botonesTabla = $(".tablaproductodevolucion tbody button.agregarProducto");
...
$(".tablaproductodevolucion").on("draw.dt", function () {
   //console.log("tabla");
...
$(".formularioDevolucion").on("click", "button.quitarProducto", function () {
...
$(".formularioDevolucion").on("change", "input.nuevaCantidadProducto", function () {
