...
$sql = "SELECT * , SUM(total) AS total FROM compra WHERE fecha LIKE '%$fechaFinal%'";
...
$sql = "SELECT *, SUM(total) AS total FROM compra WHERE fecha BETWEEN '$fechaInicial' AND '$fechaFinalMasUno'";
} else {
$sql = "SELECT *, SUM(total) AS total FROM compra WHERE fecha BETWEEN '$fechaInicial' AND '$fechaFinal'";
}
}
