...
if(localStorage.getItem("capturarRango1") != null){
	...
	$("#daterange-btn1 span").html(localStorage.getItem("capturarRango1"));
...
$('#daterange-btn1').daterangepicker(
  ...
  function (start, end) {
    ...
    var capturarRango = $("#daterange-btn1 span").html();
   	...
   	localStorage.setItem("capturarRango1", capturarRango);

   	window.location = rutaOculta+"ventas/reporteventas&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
...
$(".daterangepicker.opensright .ranges li").on("click", function(){
    ...
    if(mes < 10){
      ...
      var fechaInicial = año+"-"+mes+"-"+dia;
    	...
    	localStorage.setItem("capturarRango1", "Hoy");
