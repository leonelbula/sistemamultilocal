      ...
      <div class="box">  
         <div class="box-header with-border">
            ...
            while ($row = $valorSald->fetch_object()):
               ...
               ?>
               <a href="<?= URL_BASE ?>plansepare/ver&id=<?= $_GET['id'] ?>">
               ...
               <?php if ($row->saldo > 0): ?>		
                  ...
                  <a href="<?= URL_BASE ?>plansepare/abonar&id=<?= $_GET['id'] ?>">
                     <button class="btn btn-primary ">
         ...
         <div class="box-body">
            ...
            <table id="tablaestadocuentaPlansepare" class="table table-bordered table-striped dt-responsive tablaestadocuentaPlansepare" width="100%">
...
foreach ($listaAbono as $key => $value):
   ?>
                     <tr>
                        ...
                        <td>
                           <div class="btn-group">
                              <a href="<?= URL_BASE ?>plansepare/editarabono&id=<?= $value['id'] ?>">
                                 <button class="btn btn-warning btnEditarCategoria">
                                    <i class="fa fa-pencil"></i> Editar
                                 </button>
                              </a>	
                              <a href="<?= URL_BASE ?>plansepare/eliminarabono&id=<?= $value['id'] ?>">
                                 <button class="btn btn-danger btnEditarCategoria">
                                    <i class="fa fa-times"></i> Eliminar
                                 </button>
                              </a>	
                              <button class="btn btn-info btnImprimirAbonoPlansepare" codigo="<?= $value['id'] ?>">
