               ...
               <form method="post" action="<?=URL_BASE?>categoria/actulizar" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control input-lg" value="<?=$row1->nombre?>"
                           placeholder="Ingresar Categoria" name="nombreCategoria" required>
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control input-lg validarCategoria tituloCategoria"
                           placeholder="Ingresar Nombre Categoria" name="nombreCategoria" required>
