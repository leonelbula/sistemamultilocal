...
$sql = "SELECT v.nombre,v.nit, c.*, SUM(c.valor) AS compra FROM compra_proveedor c INNER JOIN proveedor v ON c.id_proveedor=v.id AND fecha  LIKE '%$fechaFinal%' GROUP BY  c.id_proveedor";
...
$sql = "SELECT v.nombre,v.nit, c.*, SUM(c.valor) AS compra FROM compra_proveedor c INNER JOIN proveedor v ON c.id_proveedor=v.id AND fecha BETWEEN '$fechaInicial' AND '$fechaFinalMasUno' GROUP BY  c.id_proveedor";
} else {
$sql = "SELECT v.nombre,v.nit, c.*, SUM(c.valor) AS compra FROM compra_proveedor c INNER JOIN proveedor v ON c.id_proveedor=v.id AND fecha BETWEEN '$fechaInicial' AND '$fechaFinal'GROUP BY  c.id_proveedor";
}
}
