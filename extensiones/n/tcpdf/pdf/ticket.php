...
public function VerVentaCodigo($codigo,$idsucursal) {
$sql = "SELECT * FROM venta WHERE codigo = $codigo AND id_sucursal = $idsucursal";
$resul = $this->db->query($sql);
return $resul;
}
...
$detalles = $factura->VerVentaCodigo($codigo,$id_sucursal);
...
<table>
		...
		<tr>
			...
			<td style="width:100px">
				...
				<hr style="border: 2px solid #666; background-color:white; width:100px;"><br>
				<div style="background-color; font-size:8.5px; text-align:center; color:red ;"><br><br>FACTURA N.$codigo <br>
				<hr style="border: 2px solid #666; background-color:white; width:100px;">
				</div>
			</td>
...
$bloque2 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:100px; font-size:8.5px;">
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
		<th style="border: 1px solid #666; background-color:white; width:100px; text-align:center; font-weight: bold">Detalles</th>				
...
$bloque4 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			<td style="border: 1px solid #9B9B9B; color:#333; background-color:white; width:100px; text-align:left">
			$item[codigo]   $item[descripcion] <br>$item[cantidad] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$  $precio
			&nbsp;&nbsp;$ $subtotalP <br>
...
$bloque6 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		<tr>
			...
			<td style=" color:#333; background-color:white; width:100px; text-align:left"></td>
		</tr>
		<tr>
		<td style=" font-size:6.5px; border: 1px solid #666; background-color:white; width:100px; text-align:center; font-weight: bold">
			--------------
		</td>			
