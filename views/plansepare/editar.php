...
<div class="containet">
   ...
   <section class="invoice">
      <form role="form" method="post" action="<?= URL_BASE ?>plansepare/actulizar" class="formularioVenta">
         ...
         <?php
               ...
               ?>
         <input type="hidden"  name="id" id="idVenta" value="<?= $id?>">
         <!-- title row -->
         <div class="row">
            <div class="col-xs-12">
            ...
            <div class="col-xs-8">
               ...
               <div class="col-xs-6">
                  <div class="form-group">
                     <label for="estado">Plazo en meses</label>					
