...
<div class="container">
   ...
   <section class="invoice">
      ...
      <!-- info row -->
      <form role="form" method="post" action="<?= URL_BASE ?>perdida/update" class="formularioPerdida">
         ...
         $destallesPerdida = perdidaController:: verPerdidaId($id, $id_sucursal);

         while ($row = $destallesPerdida->fetch_object()) {
         ...
         <div class="modal-body">
            ...
            <div class="box-body">
               ...
               <div class="col-xs-12 table-responsive modalProduto">
                  <table class="table table-bordered table-striped dt-responsive  tablaproductoperdida">
                     <thead>
                        <tr>
                           <th>#</th>
                           <th>codigo</th>
