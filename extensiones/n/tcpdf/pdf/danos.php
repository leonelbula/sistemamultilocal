...
$sql = "SELECT * FROM perdida WHERE id_sucursal = $idsucursal AND fecha LIKE '%$fechaFinal%'";
...
$sql = "SELECT * FROM perdida WHERE id_sucursal = $idsucursal AND fecha BETWEEN '$fechaInicial' AND '$fechaFinalMasUno'";
} else {
$sql = "SELECT * FROM perdida WHERE id_sucursal = $idsucursal AND fecha BETWEEN '$fechaInicial' AND '$fechaFinal'";
}
}
...
$productos = $value['detalles'];
   
$detallesProductos = json_decode($productos, true);

var_dump($detallesProductos);
