   ...
   <section class="content">
      ...
      <div class="box">
         ...
         <div class="box-body">
            ...
            <table id="ventasClienteRealizadas" class="table table-bordered table-striped dt-responsive ventasClienteRealizadas" width="100%">
...
while ($row = $listaEstado->fetch_object()) :
   ?>
                        ...
                        <td>
                           <div class="btn-group">
                              <a href="<?= URL_BASE ?>cliente/abonosfactura&id=<?= $row->id ?>">
                                 <button class="btn btn-warning btnEditarCategoria">
                                    <i class="fa fa-eye"></i> Ver Abonos
                                 </button>
                              </a>
   <?php if ($row->saldo > 0): ?>		
                                 <a href="<?= URL_BASE ?>cliente/abonarfactura&id=<?= $row->id ?>">
...
<script>
      $(function () {
         $('#ventasClienteRealizadas').DataTable()
