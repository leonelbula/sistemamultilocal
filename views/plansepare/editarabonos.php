      ...
      <div class="box">
         ...
         foreach ($DatosAbono as $key => $value):
            ...
            <div class="box-header with-border">
               <a href="<?= URL_BASE ?>plansepare/abonos&id=<?= $value['id_registro'] ?>">
            ...
            <div class="box-body">
               ...
               <div class="row">
                  <form action="<?= URL_BASE ?>plansepare/actualizarabono" method="POST" >
                     <?php
                     $id = $value['id_registro'];

                     $compra = plansepareController::plansepareId($id);
