...
<head>
   ...
   <!-- DataTables -->
   <link rel="stylesheet"
      href="<?=URL_BASE?>assets/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
   <link rel="stylesheet"
      href="<?=URL_BASE?>assets/bower_components/datatables.net-bs/css/responsive.bootstrap.min.css">
