   ...
   <section class="content">
      ...
      <div class="box">
         ...
         <div class="box-header with-border">
            ...
            <!--
            <a href=" URL_BASE parametros/cargarInventario">
               <button class="btn btn-primary">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalRegistrarDatos"
               data-dismiss="modal">
               Agregar Datos
            </button>
            <?php } else { ?>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalEditarDatos"
               data-dismiss="modal">
               Editar Datos
            </button>
            <?php } ?>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalEditarParametros"
               data-dismiss="modal">
                  ...
                  <div class="panel panel-default">
                     ...
                     <ul class="list-group">
                        ...
                        <li class="list-group-item"><b>Departamento: </b>
                           <h4><?= $row->departamento ?> </h4>
                        </li>
                        <li class="list-group-item"><b>Telefono:</b>
                           <h4> <?= $row->telefono ?></h4>
                        </li>
                        <li class="list-group-item"><b>Celular:</b>
                           <h4> <?= $row->celular ?></h4>
                        </li>
                        <li class="list-group-item"><b>Email:</b>
                           <h4> <?= $row->email ?></h4>
                        </li>
                        <li class="list-group-item"><b>Regimen:</b>
                           <h4> <?= $row->regimen ?></h4>
                        </li>
                        <li class="list-group-item"><b>Eslogan:</b>
                           <h4> <?= $row->eslogan ?></h4>
                        </li>
                        <?php endwhile; ?>
                     </ul>
               ...
               <div class="box-body">
                  ...
                  <div class="panel panel-default">
                     ...
                     <ul class="list-group">
                        ...
                        <li class="list-group-item"><b>Numero de Inicio Facturacion:</b>
                           <h4> <?= $row->num_inicio_factura ?></h4>
                        </li>

                        <li class="list-group-item"><b>General Codigo Producto Automatico:</b>
                           <h4> <?php
                        ...
                        <li class="list-group-item"><b>Codigo Producto:</b>
                           <h4> <?= $row->codigo_prod ?></h4>
                        </li>
               ...
               <div class="box-body">
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="celular" data-inputmask='"mask": "(999) 999-9999"'
                           data-mask>
                     </div>
                     <!-- /.input group -->
                  </div>
               ...
               <div class="box-body">
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="departamento" value="<?= $row->departamento ?>"
                           required>
                     </div>
                     <!-- /.input group -->
                  </div>
               ...
               <div class="box-body">
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        ...
                        <input type="number" class="form-control" name="num_inicio_factura"
                           value="<?= $row->num_inicio_factura ?>" required>
                     </div>
                     <!-- /.input group -->
                  </div>
                  <div class="form-group">
